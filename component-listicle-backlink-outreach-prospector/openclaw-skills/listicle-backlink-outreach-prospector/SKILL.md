...
Never send outreach unless the project approval rules explicitly allow it, the approver approves the send batch, and compliance/opt-out requirements are satisfied.
